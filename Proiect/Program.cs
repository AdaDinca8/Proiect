...
{
    options.Conventions.AuthorizeFolder("/CoffeeShops");
    options.Conventions.AllowAnonymousToPage("/CoffeeShops/Index");
    options.Conventions.AllowAnonymousToPage("/CoffeeShops/Details");
